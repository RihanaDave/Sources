...
{
    public partial class PropertyPickerUserControl : UserControl
    {
        #region Dependencies
        ...
        public static readonly DependencyProperty IsExpandedProperty =
            DependencyProperty.Register(nameof(IsExpanded), typeof(bool), typeof(PropertyPickerUserControl),
        ...
        {
            ((PropertyPickerUserControl)d).OnSetIsExpandedChanged(e);
        }
        ...
        public static readonly DependencyProperty ObjectTypeUriCollectionProperty =
            DependencyProperty.Register(nameof(ObjectTypeUriCollection), typeof(ObservableCollection<string>),
                typeof(PropertyPickerUserControl),
        ...
        {
            ((PropertyPickerUserControl)d).OsSetObjectTypeUriCollectionChanged(e);
        }
        ...
        private void OsSetObjectTypeUriCollectionChanged(DependencyPropertyChangedEventArgs e)
        {
            ...
            if (e.OldValue == null)
                OnObjectTypeUriCollectionChanged(new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Add,
                    e.NewValue));
            else
                OnObjectTypeUriCollectionChanged(new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Replace,
        ...
        public static readonly DependencyProperty PropertyTypeUriCollectionProperty =
            DependencyProperty.Register(nameof(PropertyTypeUriCollection), typeof(ObservableCollection<string>),
                typeof(PropertyPickerUserControl),
        ...
        {
            ((PropertyPickerUserControl)d).OnSetPropertyTypeUriCollectionChanged(e);
        }
        ...
        private void OnSetPropertyTypeUriCollectionChanged(DependencyPropertyChangedEventArgs e)
        {
            ...
            if (e.OldValue == null)
            {
                OnPropertyTypeUriCollectionChanged(new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Add,
                    PropertyTypeUriCollection));
            }
            else
            {
                OnPropertyTypeUriCollectionChanged(new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Replace,
                    PropertyTypeUriCollection, e.OldValue));
            }
        }
        ...
        public static readonly DependencyProperty ExceptTypeUriCollectionProperty =
            DependencyProperty.Register(nameof(ExceptTypeUriCollection), typeof(ObservableCollection<string>),
                typeof(PropertyPickerUserControl),
        ...
        {
            ((PropertyPickerUserControl)d).OnSetExceptTypeUriCollectionChanged(e);
        }
        ...
        private void OnSetExceptTypeUriCollectionChanged(DependencyPropertyChangedEventArgs e)
        {
            ...
            if (e.OldValue == null)
                OnExceptTypeUriCollectionChanged(new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Add,
                    e.NewValue));
            else
                OnExceptTypeUriCollectionChanged(new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Replace, 
                    e.NewValue, e.OldValue));
        }
        ...
        public static readonly DependencyProperty DataTypeFilterCollectionProperty =
            DependencyProperty.Register(nameof(DataTypeFilterCollection), typeof(ObservableCollection<BaseDataTypes>),
                typeof(PropertyPickerUserControl),
        ...
        {
            ((PropertyPickerUserControl)d).OnSetDataTypeFilterCollectionChanged(e);
        }
        ...
        public static readonly DependencyProperty ExceptDataTypeCollectionProperty =
            DependencyProperty.Register(nameof(ExceptDataTypeCollection), typeof(ObservableCollection<BaseDataTypes>),
                typeof(PropertyPickerUserControl),
        ...
        {
            ((PropertyPickerUserControl)d).OnSetExceptDataTypeCollectionChanged(e);
        }
        ...
        private void OnSetExceptDataTypeCollectionChanged(DependencyPropertyChangedEventArgs e)
        {
            ...
            if (e.OldValue == null)
                ...
                OnExceptDataTypeCollectionChanged(new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Replace, 
                    e.NewValue, e.OldValue));
        }
        ...
        public static readonly DependencyProperty ItemCollectionProperty =
            DependencyProperty.Register(nameof(ItemCollection), typeof(ObservableCollection<TreeViewPickerItem>),
                typeof(PropertyPickerUserControl),
        ...
        {
            ((PropertyPickerUserControl)d).OnSetItemCollectionChanged(e);
        }
        ...
        private void OnSetItemCollectionChanged(DependencyPropertyChangedEventArgs e)
        {
            ...
            if (e.OldValue == null)
                ...
                OnItemCollectionChanged(new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Replace, e.NewValue,
                    e.OldValue));
        }
        ...
        public static readonly DependencyProperty SelectedItemProperty =
            DependencyProperty.Register(nameof(SelectedItem), typeof(PropertyNode), typeof(PropertyPickerUserControl),
        ...
        {
            ((PropertyPickerUserControl)d).OnSetSelectedItemChanged(e);
        }
        ...
        public static readonly DependencyProperty TextProperty =
            DependencyProperty.Register(nameof(Text), typeof(string), typeof(PropertyPickerUserControl),
                new PropertyMetadata(string.Empty, OnSetTextChanged));

        private static void OnSetTextChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ((PropertyPickerUserControl)d).OnSetTextChanged(e);
        }
        ...
        public static readonly DependencyProperty DisplayModeProperty =
            DependencyProperty.Register(nameof(DisplayMode), typeof(DisplayMode), typeof(PropertyPickerUserControl), 
                new PropertyMetadata(DisplayMode.DropDown));
        ...
        public PropertyPickerUserControl()
        {
            InitializeComponent();
            InitProperties();
            BindProperties();
        ...
        private void CreateOntologyTree()
        {
            ...
            ObservableCollection<OntologyNode> treeProperty;
        ...
        private ObservableCollection<TreeViewPickerItem> CreateHierarchyObjects(ObservableCollection<OntologyNode> nodes)
        {
            ...
            try
            {
                if (nodes.Count > 0)
                {
                    foreach (PropertyNode node in nodes.OfType<PropertyNode>())
                    {

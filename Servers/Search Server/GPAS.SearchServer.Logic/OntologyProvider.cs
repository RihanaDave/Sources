...
using static GPAS.Ontology.Ontology;
using System.Collections.Generic;
using GPAS.SearchServer.Access.DispatchService;
...
namespace GPAS.SearchServer
{
    ...
    public class OntologyProvider : IDisposable
    {
        ...
        private static Stream GetCompressedOntologyFromDispatch()
        {
            ...
            InfrastructureServiceClient client = null;
            Stream result = null;
            try
            {
                client = new InfrastructureServiceClient();

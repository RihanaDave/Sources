    ...
    public class Win7ColorHotTrackExtension
    {
        ...
        static void Win7ColorHotTrackExtenssion_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            if (control.GetValue(FrameworkElement.TagProperty) == null)
            {
                ...
                // we dont need to perform any action, couse the result will be a transparent Fill anyway
        ...
        public static bool GetApplyHotTracking(DependencyObject sender)
        {
            return (bool)sender.GetValue(Win7ColorHotTrackExtension.ApplyHotTrackingProperty);
        }
        ...
        public static void SetApplyHotTracking(DependencyObject sender, bool value)
        {

...
{
    /// <summary>
    /// این کنترل وظیفه نمایش اشیاء موجود در آنتولوژی را بصورت درختی برعهده دارد.
    /// </summary>
    public partial class ObjectTypePicker : PresentationControl
    {
        #region Dependencies
        ...
        public static readonly DependencyProperty IsExpandedProperty =
            DependencyProperty.Register(nameof(IsExpanded), typeof(bool), typeof(ObjectTypePicker),
        ...
        {
            ((ObjectTypePicker)d).OnSetIsExpandedChanged(e);
        }
        ...
        public static readonly DependencyProperty ObjectTypeUriCollectionProperty =
            DependencyProperty.Register(nameof(ObjectTypeUriCollection), typeof(ObservableCollection<string>), typeof(ObjectTypePicker),
        ...
        {
            ((ObjectTypePicker)d).OnSetObjectTypeUriCollectionChanged(e);
        }
        ...
        public static readonly DependencyProperty ExceptTypeUriCollectionProperty =
            DependencyProperty.Register(nameof(ExceptTypeUriCollection), typeof(ObservableCollection<string>), typeof(ObjectTypePicker),
        ...
        {
            ((ObjectTypePicker)d).OnSetExceptTypeUriCollectionChanged(e);
        }
        ...
        public static readonly DependencyProperty ObjectsRelatedLikeTypeProperty =
            DependencyProperty.Register(nameof(ObjectsRelatedLikeType), typeof(Tuple<string, List<string>>), typeof(ObjectTypePicker),
        ...
        {
            ((ObjectTypePicker)d).OnSetObjectsRelatedLikeTypeChanged(e);
        }
        ...
        protected static readonly DependencyProperty ItemCollectionProperty =
            DependencyProperty.Register(nameof(ItemCollection), typeof(ObservableCollection<TreeViewPickerItem>), typeof(ObjectTypePicker),
        ...
        {
            ((ObjectTypePicker)d).OnSetItemCollectionChanged(e);
        }
        ...
        public static readonly DependencyProperty SelectedItemProperty =
            DependencyProperty.Register(nameof(SelectedItem), typeof(OntologyNode), typeof(ObjectTypePicker),
        ...
        {
            ((ObjectTypePicker)d).OnSetSelectedItemChanged(e);
        }
        ...
        public static readonly DependencyProperty TextProperty =
            DependencyProperty.Register(nameof(Text), typeof(string), typeof(ObjectTypePicker),
                new PropertyMetadata(string.Empty, OnSetTextChanged));

        private static void OnSetTextChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ((ObjectTypePicker)d).OnSetTextChanged(e);
        }
        ...
        public static readonly DependencyProperty DisplayModeProperty =
            DependencyProperty.Register(nameof(DisplayMode), typeof(DisplayMode), typeof(ObjectTypePicker), new PropertyMetadata(DisplayMode.DropDown));
        ...
        public static readonly DependencyProperty DisplayCheckIconForSelectableItemsProperty =
            DependencyProperty.Register(nameof(DisplayCheckIconForSelectableItems), typeof(bool), typeof(ObjectTypePicker),
        ...
        private void CreateOntologyTree()
        {
            ...
            ObservableCollection<OntologyNode> treeObject = new ObservableCollection<OntologyNode>();
        ...
        private void AddEmptyItem()
        {
            ...
            {
                Title = Properties.Resources.No_Object,
                IsSelectable = false
            });
        }
        ...
        private void GetDefautExceptTypeUriList()
        {
            ...
            //Below line write in new ETL. After activate unstructured import must remove below lines.
            if (currentOntology != null)
                defaultExceptTypeUriList.Add(currentOntology.GetDocumentTypeURI());
        }

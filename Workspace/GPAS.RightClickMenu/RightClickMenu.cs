...
{
    public class RightClickMenu : ItemsControl
    {
        ...
        //public static readonly DependencyProperty MenuIconUriProperty;

        //public static Queue<Point> mousePositionsQueue = new Queue<Point>();
        ...
        { 
            get
            {
                return (double)base.GetValue(RightClickMenu.RadiusProperty);
            }
            set
            {
                base.SetValue(RightClickMenu.RadiusProperty, value);
            }
        }
        ...
        public double InnerRadius
        {
            get
            {
                return (double)base.GetValue(RightClickMenu.InnerRadiusProperty);
            }
            set
            {
                base.SetValue(RightClickMenu.InnerRadiusProperty, value);
            }
        }
        ...
        public double SectorGap
        {
            get
            {
                return (double)base.GetValue(RightClickMenu.SectorGapProperty);
            }
            set
            {
                base.SetValue(RightClickMenu.SectorGapProperty, value);
            }
        }
        ...
        public double Gap
        {
            get
            {
                return (double)base.GetValue(RightClickMenu.GapProperty);
            }
            set
            {
                base.SetValue(RightClickMenu.GapProperty, value);
            }
        }
        ...
        public double MenuSector
        {
            get
            {
                return (double)base.GetValue(RightClickMenu.MenuSectorProperty);
            }
            set
            {
                base.SetValue(RightClickMenu.MenuSectorProperty, value);
            }
        }
        [Bindable(true)]
        public Brush SelectedBackground
        {
            get 
            {
                return (Brush)base.GetValue(RightClickMenu.SelectedBackgroundProperty);
            }
            set
            {
                base.SetValue(RightClickMenu.SelectedBackgroundProperty, value);
            }
        }
        ...
        public double Rotation
        {
            get
            {
                return (double)base.GetValue(RightClickMenu.RotationProperty);
            }
            set
            {
                base.SetValue(RightClickMenu.RotationProperty, value);
            }
        }
        ...
        public bool RotateText
        {
            get
            {
                return (bool)base.GetValue(RightClickMenu.RotateTextProperty);
            }
            set
            {
                base.SetValue(RightClickMenu.RotateTextProperty, value);
            }
        }
        ...
        //    get
        //    {
        //        return (string)base.GetValue(RightClickMenu.MenuIconUriProperty);
        //    }
        //    set
        //    {
        //        base.SetValue(RightClickMenu.MenuIconUriProperty, value);
        //    }
        //}
        ...
        public int _current_level = -1;
        public int _current_selection = -1;
        private bool _was_selected = false;
        private double _size;

        static RightClickMenu()
        {                       
            RightClickMenu.RadiusProperty = DependencyProperty.Register("Radius", typeof(double), typeof(RightClickMenu), new FrameworkPropertyMetadata(50.0));
            RightClickMenu.InnerRadiusProperty = DependencyProperty.Register("InnerRadius", typeof(double), typeof(RightClickMenu), new FrameworkPropertyMetadata(10.0));
            RightClickMenu.SectorGapProperty = DependencyProperty.Register("SectorGap", typeof(double), typeof(RightClickMenu), new FrameworkPropertyMetadata(5.0));
            RightClickMenu.GapProperty = DependencyProperty.Register("Gap", typeof(double), typeof(RightClickMenu), new FrameworkPropertyMetadata(5.0));
            RightClickMenu.MenuSectorProperty = DependencyProperty.Register("MenuSector", typeof(double), typeof(RightClickMenu), new FrameworkPropertyMetadata(360.0));
            RightClickMenu.SelectedBackgroundProperty = DependencyProperty.Register("SelectedBackground", typeof(Brush), typeof(RightClickMenu), new FrameworkPropertyMetadata(Brushes.Gray));
            RightClickMenu.RotationProperty = DependencyProperty.Register("Rotation", typeof(double), typeof(RightClickMenu), new FrameworkPropertyMetadata(0.0));
            RightClickMenu.RotateTextProperty = DependencyProperty.Register("RotateText", typeof(bool), typeof(RightClickMenu), new FrameworkPropertyMetadata(true));            
            //RightClickMenu.MenuIconUriProperty = DependencyProperty.Register("IconUri", typeof(string), typeof(RightClickMenu));
        }
        ...
        protected override Size MeasureOverride(Size availablesize)
        {
            ...
            {
                ss = Math.Max(ss, (i as RightClickMenuItem).CalculateSize(s, d));
            }
        ...
        //{      
        //    base.OnMouseMove(e);
        //    if (mousePositionsQueue.Count > 10)
        //        mousePositionsQueue.Dequeue();

        //    mousePositionsQueue.Enqueue(e.MouseDevice.GetPosition(this));
        ...
        public void Up(Point point)
        {
            ...
            if (level == _current_level && selection == _current_selection)
            {
                ...
                (items_control as RightClickMenuItem).OnClick();
        ...
        private void DrawMenu(ItemsControl items_control, int level, double angle, double sector, DrawingContext drawingContext)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                RightClickMenuItem menu_item = items_control.Items[i] as RightClickMenuItem;
                ...
                if (_selection.GetSelection(level) == i && (items_control.Items[i] as RightClickMenuItem).IsEnabled  == true)
                {
                ...
                //var myImage = new BitmapImage(new Uri(menu_item.IconUri));
                var myImage = menu_item.Icon;
...
#pragma warning restore CS0618 // 'FormattedText.FormattedText(string, CultureInfo, FlowDirection, Typeface, double, Brush)' is obsolete: 'Use the PixelsPerDip override'
                // Calculate placement of text and image
                int imageWidth = 50;
                int imageHeight = 50;
                Point text_point = new Point(center.X - text.Width / 2.0, center.Y - text.Height / 2.0);
                Point new_text_point = new Point();
                new_text_point.X = text_point.X;
                new_text_point.Y = text_point.Y + 18.5;
                ...
                drawingContext.DrawText(text, new_text_point);
                Point text_point1 = new Point(center.X - 50 / 2.0, center.Y - 50 / 2.0);
                drawingContext.DrawImage(myImage,
                          new Rect(text_point1.X, text_point1.Y - 10.5, imageWidth, imageHeight));

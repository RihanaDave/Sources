...
namespace GPAS.Horizon.GraphRepositoryPlugins.OrientRestV3
{
    ...
    {
        private readonly string GraphRepositoryIP = ConfigurationManager.AppSettings["GPAS.Horizon.GraphRepositoryPlugins.OrientRestV3.RepositoryIP"];
        private readonly string UserName = ConfigurationManager.AppSettings["GPAS.Horizon.GraphRepositoryPlugins.OrientRestV3.RepositoryUser"];
        private readonly string Password = ConfigurationManager.AppSettings["GPAS.Horizon.GraphRepositoryPlugins.OrientRestV3.RepositoryPassword"];
        private readonly string DatabaseName = ConfigurationManager.AppSettings["GPAS.Horizon.GraphRepositoryPlugins.OrientRestV3.DatabaseName"];
